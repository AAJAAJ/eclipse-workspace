            ...
            <div class="layui-row">
                <form class="layui-form" method="post" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                        <%
                        MotifController mo = new MotifController();
                        List<Motif> list = mo.queryMotifList();
                        		session.setAttribute("list", list);
                        %>
                        <c:forEach items="${list }" var="motif">
                            <input type="radio" id="motif" value="${motif.id }" name="motif" required="" lay-verify="nikename" autocomplete="off" class="layui-input">${motif.motif }<br>
                        </c:forEach>
                        </div>
                    </div>
                    <div class="layui-form-item">
...
<script>layui.use(['form', 'layer','jquery'],
            function() {
                ...
                form.on('submit(add)',
                    ...
                    location.href = "news-controller.jsp?type=add&title="+data.field.title+"&content="+data.field.content
                    		+"&id="+data.field.motif;
                    //关闭当前frame
                    xadmin.close();
                    // 可以对父窗口进行刷新 
